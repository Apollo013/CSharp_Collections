...
namespace CSharpCollections.Collections.Concurrent
{
    class ConcurrentDictionaryCollection : BaseClass
    {
        ...
        {
            PrintSubTitle($"THREAD ID: {Thread.CurrentThread.Name}");
